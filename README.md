...
```shell script
go get -u github.com/AmanTrance/go-paymail
```

<br/>

## Documentation
View the generated [documentation](https://pkg.go.dev/github.com/AmanTrance/go-paymail)

[![GoDoc](https://godoc.org/github.com/AmanTrance/go-paymail?status.svg&style=flat&v=4)](https://pkg.go.dev/github.com/AmanTrance/go-paymail)
...
## Examples & Tests
All unit tests and [examples](examples) run via [GitHub Actions](https://github.com/AmanTrance/go-paymail/actions) and
